              ...
              style={{flex:1, borderRadius:20}}>
                ...
                <View style={{margin:10,}}>
                    <View style={{flexDirection:'row', justifyContent:'space-between', }}>
                        ...
                        <Text style={styles.fetchedContent}> {item.ticket.ticketNumber}</Text>
                    </View>
                    <View style={{flexDirection:'row', justifyContent:'space-between'}}>
                        <Text style={styles.detailsText}>Created Date: </Text>
                        <Text style={styles.fetchedContent}> Date </Text>
                    </View>
                    <View style={{flexDirection:'row', justifyContent:'space-between'}}>
                    ...
                    <View style={{flexDirection:'row', justifyContent:'space-between'}}>
                        ...
                        <Text style={styles.fetchedContent}> {item.currentStatus.status}</Text>
                    </View>
                    <View style={{flexDirection:'row', justifyContent:'space-between'}}>
                        <Text style={styles.detailsText}>Criticality: </Text>
                        <Text style={styles.fetchedContent}> {item.ticket.criticality}</Text>
                    </View>
                    <View style={{flexDirection:'row', justifyContent:'space-between'}}>
            ...
            <LinearGradient
                ...
                <View style={{margin:10,}}>
                    <View style={{flexDirection:'row', justifyContent:'space-between'}}>
                        ...
                        <Text style={styles.fetchedContent}> {item.customer.name}</Text>
                    </View>
                    <View style={{flexDirection:'row', justifyContent:'space-between'}}>
                        <Text style={styles.detailsText}>Mobile Number: </Text>
                        <Text style={styles.fetchedContent}> {item.customer.mobileNumber}</Text>
                    </View>
                    <View style={{flexDirection:'row', justifyContent:'space-between'}}>
            ...
            <LinearGradient
                ...
                <View style={{margin:10,}}>
                    <View style={{flexDirection:'row', justifyContent:'space-between'}}>
                        ...
                        <Text style={styles.fetchedContent}> {item.machine.machineNumber}</Text>
                    </View>
                    <View style={{flexDirection:'row', justifyContent:'space-between'}}>
                    ...
                    <View style={{flexDirection:'row', justifyContent:'space-between'}}>
                        ...
                        <Text style={styles.fetchedContent}> {item.machine.machineModel}</Text>
                    </View>
                    <View style={{flexDirection:'row', justifyContent:'space-between'}}>
                    ...
                    <View style={{flexDirection:'row', justifyContent:'space-between'}}>
                        <Text style={styles.detailsText}>State: </Text>
                        <Text style={styles.fetchedContent}> Machine State</Text>
                    </View>
                    <View style={{flexDirection:'row', justifyContent:'space-between'}}>
                        <Text style={styles.detailsText}>District: </Text>
                        <Text style={styles.fetchedContent}> Machine District</Text>   
                    </View>
                    <View style={{flexDirection:'row', justifyContent:'space-between'}}>
                        <Text style={styles.detailsText}>Tehsil: </Text>
                    </View>
            ...
            <LinearGradient
                ...
                <View style={{margin:10,}}>
                    <View style={{flexDirection:'row', justifyContent:'space-between'}}>
                        ...
                        <Text style={styles.fetchedContent}> {item.remarks.remark}</Text>
                    </View>
                    <View style={{flexDirection:'row', justifyContent:'space-between'}}>
                        <Text style={styles.detailsText}>Service Type: </Text>
                        <Text style={styles.fetchedContent}> {item.remarks.serviceType}</Text>
                    </View>
                    <View style={{flexDirection:'row', justifyContent:'space-between'}}>
